...
| [Аналитика рынка IT (hh.ru)](projects/05-demos-mvp/it-market-report/README.md) | Аналитика спроса на IT-специалистов | [demo/report.html](https://leader-it.com/demo/report.html) | в портфолио |
| [Рынок IT — статистика и цитаты](projects/05-demos-mvp/it-market-stats/README.md) | Аналитический отчёт: статистика IT-проектов + фильтруемые цитаты по тегам | [demo/20260615_f89e86.html](https://leader-it.com/demo/20260615_f89e86.html) | в портфолио |
...
| sell-dreamhouse-importer | Гайды телефонных продаж: скрипты звонков, отработка возражений, product-sheet | переносится |
